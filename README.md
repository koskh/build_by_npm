...
выдумывать аналоги для `#ifdef DEBUG console.log(value) #endif` состояний.
...
````
Для более сложный DEBUG состояний можно использовать [Conditional compilation](https://github.com/mishoo/UglifyJS2#compressor-options)
